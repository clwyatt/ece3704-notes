...
\begin{figure}
  \centering
  \includegraphics[alt={circular contour of integration for the example}]{figures/fig8_1}
...
\begin{figure}
  \centering
  \includegraphics[alt={line contour of integration for the example}]{figures/fig8_2}
...
\begin{figure}
  \centering
  \includegraphics[alt={two contours of integration for the example}]{figures/fig8_3}
...
\begin{figure}
  \centering
  \includegraphics[alt={circular contour of integration for the example}]{figures/fig8_4}
...
\begin{figure}
  \centering
  \includegraphics[alt={linear contour of integration}]{figures/fig8_5}
...
\begin{figure}
  \centering
  \includegraphics[alt={Bromwitch contour of integration}]{figures/fig8_6}
