...
\begin{figure}
  \centering
  \includegraphics[alt={RC circuit with non-zero initial condition. See caption.}]{figures/fig12_1}
  \caption{Single pole, single throw switch connected to either a DC voltage source or an arbitrary voltage signal $x(t)$.}
\end{figure}
