...
\begin{figure}
  \centering
  \includegraphics[width=0.8\linewidth, alt="the magnitude spectrum of a band-limited signal"]{figures/bandlimited}
...
\begin{figure}
  \centering
  \includegraphics[width=0.8\linewidth, alt="the magnitude spectrum of a band-limited signal after sampling at the Nyquist rate"]{figures/bandlimitedsampled1}
...
\begin{figure}
  \centering
  \includegraphics[width=0.8\linewidth, alt="the magnitude spectrum of a band-limited signal after sampling below the Nyquist rate"]{figures/bandlimitedsampled2}
...
\begin{figure}
  \centering
  \includegraphics[width=0.8\linewidth, alt="schematic of a circuit implementing a sample and hold"]{figures/sample_hold}
\end{figure}
