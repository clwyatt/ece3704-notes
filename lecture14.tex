...
\begin{figure}
  \centering
  \includegraphics[alt={block diagram for example 1}]{figures/fig14_1}
  \caption{Block diagram for example 1.}
\end{figure}
...
\item All signs of the first column ($a_0, a_1, b_1, c_1,\ldots, e_1, f_1,g_1$) must be positive for the system to be stable.
\end{enumerate}
...
\begin{figure}
  \centering
  \includegraphics[alt={asymptotic plot for first-order zero. See text.}]{figures/fig14_3}
  \caption{Asymptotic plot for first-order zero.}
\end{figure}
...
\begin{figure}
  \centering
  \includegraphics[alt={asymptotic plot for first-order zero and pole. See text.}]{figures/fig14_4}
  \caption{Asymptotic plot for first-order zero (left) and first-order pole (right).}
\end{figure}
...
\item zero at the origin
  ...
  \]
The linear approximation is equivalent to a zero approaching the $\omega = 0$ axis.
  
\item pole at the origin
  \[
  20\log_{10}\left|\frac{1}{j\omega}\right| = -20\log_{10}(\omega)
  \]
The linear approximation is equivalent to a pole approaching the $\omega = 0$ axis.
    
\item second order with complex poles $-a, -a^*$
  \[
  H(s) = \frac{|a|^2}{(s+a)(s+a^*)} = \frac{\omega_0^2}{s^2 + 2\eta\omega_0 s + \omega_0^2}
  \]
  \begin{itemize}
...
\begin{figure}
  \centering
  \includegraphics[alt={illustration of a second-order system. See caption.}]{figures/fig14_5}
  \caption{Illustration of a second-order system with $\omega_0 = 10$ and $\eta = 0.2$. The linear approximation is a constant of zero dB up to $\omega_0$, followed by a linear decrease of 20 dB per decade.}
\end{figure}
