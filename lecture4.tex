...
\begin{figure}
  \centering
  \includegraphics[width=0.8\linewidth, alt="schematic depiction of analysis of continuous-time systems using Fourier techniques"]{figures/fig4_1.svg}
\end{figure}
...
\begin{figure}
  \centering
  \includegraphics[width=0.8\linewidth, alt="schematic depiction of analysis of discrete-time systems using Fourier techniques"]{figures/fig4_2.svg}
\end{figure}
...
\begin{figure}
  \centering
  \includegraphics[width=0.8\linewidth, alt="block diagram of two systems in series"]{figures/fig4_3.svg}
\end{figure}
...
\item The corresponding LCCDE is
  ...
  \begin{figure}
  \centering
  \includegraphics[width=0.8\linewidth, alt="block diagram of the inverse system"]{figures/fig4_4.svg}
  \end{figure}
