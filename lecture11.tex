...
\begin{figure}
  \centering
  \includegraphics[alt={integrator block. See caption.}]{figures/fig11_1}
...
\begin{figure}
  \centering
  \includegraphics[alt={integrator block in Laplace domain. See caption.}]{figures/fig11_2}
...
\begin{figure}
  \centering
  \includegraphics[alt={illustration of analysis approach using Laplace. See caption.}]{figures/fig11_3}
