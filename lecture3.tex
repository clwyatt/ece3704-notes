...
\item basic block
    \begin{figure}
    \centering
    \includegraphics[alt="block diagram for basic block"]{figures/fig3_1}
    \caption{$y(t) = h(t)*x(t)$}
  \end{figure}
  \item series motif
    \begin{figure}
    \centering
    \includegraphics[alt="block diagram for series motif"]{figures/fig3_2}
    \caption{$y(t) = [h_1(t)*h_2(t)]*x(t)$}
    \end{figure}
  \item parallel motif
    \begin{figure}
    \centering
    \includegraphics[alt="block diagram for parallel motif"]{figures/fig3_3}
    \caption{$y(t) = [h_1(t) + h_2(t)]*x(t)$}
    \end{figure}
  \item feedback motif
    \begin{figure}
      \centering
    \includegraphics[alt="block diagram for feedback motif"]{figures/fig3_4}
...
\begin{figure}
  \centering
  \includegraphics[alt="block diagram for integrator blocks"]{figures/fig3_5}
...
\begin{figure}
  \centering
  \includegraphics[alt="block diagram for PID controller"]{figures/fig3_6}
...
\begin{figure}
  \centering
  \includegraphics[alt="block diagram for delay blocks"]{figures/fig3_7}
...
\begin{figure}
  \centering
  \includegraphics[alt="block diagram for fourth order FIR filter"]{figures/fig3_8}
...
\item
  ...
  \begin{figure}
  \centering
  \includegraphics[alt="block diagram for example 1"]{figures/fig3_9}
  \end{figure}
