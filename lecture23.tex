...
\item Direct Form II removes the redundant delay line, but is susceptible to internal overflow. The output of each delay block can grow much larger than the input or output, potentially clipping or wrapping the signal in fixed-point systems, depending on the fixed-point format used and compiler optimizations.
